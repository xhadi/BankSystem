...
public class EndUser extends User {
    ...
    public EndUser(String nationalID, String fullName, Date dateOfBirth, String phone,
        ...
        accounts.add(new Account(nationalID));
    }
    ...
    public boolean deposit(double amount) {
        ...
        System.out.println("Chose one of your account(s) to deposit in it");
